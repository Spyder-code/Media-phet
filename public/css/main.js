...
function show_hide(){
    if(a==1){
        document.querySelector(".hidden-click").style.display="inline";
        document.querySelector(".hidden-click2").style.display="inline";
        document.querySelector(".avartar-picker label").style.display="inline";
        document.querySelector(".profil").style.display="none";
        return a=1;
    }
    else{
        document.querySelector(".hidden-click").style.display="none";
        document.querySelector(".hidden-click2").style.display="none";
        document.querySelector(".avartar-picker label").style.display="none";
...
function show(){
    if(a==1){
        ...
        document.querySelector(".hidden-click2").style.display="none";
        document.querySelector(".avartar-picker label").style.display="none";
        document.querySelector(".profil").style.display="inline";
        return a=1;
    }
    else{
        document.querySelector(".hidden-click").style.display="none";document.querySelector(".hidden-click2").style.display="none";
        document.querySelector(".avartar-picker label").style.display="none";
        return a=1;
    }
}