...
<div id="unity-container" class="unity-desktop">
    ...
    <div id="unity-footer">
      ...
      <div id="unity-build-title">Elementary School</div>
    </div>
  </div>
  <script>
    ...
    var buildUrl = {!! json_encode(asset('game/1/Build')) !!};
    var loaderUrl = buildUrl + "/Elementary.loader.js";
    var config = {
      dataUrl: buildUrl + "/Elementary.data.unityweb",
      frameworkUrl: buildUrl + "/Elementary.framework.js.unityweb",
      codeUrl: buildUrl + "/Elementary.wasm.unityweb",
      streamingAssetsUrl: "StreamingAssets",
      companyName: "DefaultCompany",
      productName: "Elementary School",
      productVersion: "1.0",
  ...
  <script>
        // var unityInstance = UnityLoader.instantiate("unityContainer", "", {onProgress: UnityProgress});
        // unityInstance.SendMessage('Main', 'username', 'Muhammad Aziz Almi');
  </script>
